...
class TestBackendUtils(unittest.TestCase):
    """Test class for GCC BackendUtils"""
    ...
    def test_replaceMarkers_stringWithSingleMarker_correctReplacedMarker(self):
    ...
    def test_replaceMarkers_stringWithMultipleSameMarkers_correctReplacedMarkers(self):
    ...
    def test_replaceMarkers_stringWithMultipleDifferentMarkers_correctReplacedMarkers(self):
    ...
    def test_replaceMarkers_stringWithMultipleSameMarkersInRow_correctReplacedMarkers(self):
    ...
    def test_replaceMarkers_stringWithNotExistentMarker_noReplacementDone(self):
    ...
    def test_convertArrayToString_onlyIntegerValues_correctStringRepresenationOfIntegerValues(self):
        """Test case for convert_array_to_string function"""
        self.assertTrue(backend_utils.convert_array_to_string([1,2,3,4]) == '{1,2,3,4}')

    def test_convertArrayToString_onlyFloatValues_correctStringRepresenationOfFloatValues(self):
    ...
    def test_convertArrayToString_mixedIntegerFloatValues_correctStringRepresenationOfIntegerFloatValues(self):
    ...
    def test_convertArrayToString_singleValue_correctStringRepresenationOfSingleValue(self):
    ...
    def test_getNumberOfLayers_2DenseLayerInput_correctNumberOfLayers(self):
    ...
    def test_getNumberOfLayers_3DenseLayerInput_correctNumberOfLayers(self):
    ...
    def test_getLayerTypesString_2DenseLayerInput_correctLayerTypesString(self):
    ...
    def test_getLayerTypesString_FlattenPoolingLayerInput_correctLayerTypesString(self):
    ...
    def test_getOutputDimensions_2DenseLayerInput_correctHeightWidthDepthDimensions(self):
    ...
    def test_getOutputDimensions_3DenseLayerInput_correctHeightWidthDepthDimensions(self):
    ...
    def test_getOutputDimensions_FlattenDenseDropOutLayerInput_correctHeightWidthDepthDimensions(self):
    ...
    def test_getOutputDimensions_poolingLayerInput_correctHeightWidthDepthDimensions(self):
    ...
    def test_getActivationFunctionString_differentActionfunctionLinearTanhSoftmaxInput_correctActivationFunctionString(self):
    ...
    def test_getBiasInformation_3DenseLayerAllUsingBiasTrueInput_correctBiasValueStringBiasIndicesString(self):
    ...
    def test_getBiasInformation_2DenseLayerAllUsingBiasTrueInput_correctBiasValueStringBiasIndicesString(self):
    ...
    def test_getBiasInformation_MixedLayerSomeUsingBiasTrueInput_correctBiasValueStringBiasIndicesString(self):
    ...
    def test_getWeightInformation_3DenseLayerAllUsingWeightsTrueInput_correctWeightsValueStringWeightsIndicesString(self):
    ...
    def test_getWeightInformation_2DenseLayerAllUsingWeightsTrueInput_correctWeightsValueStringWeightsIndicesString(self):
    ...
    def test_getWeightInformation_MixedLayerSomeUsingWeightsTrueInput_correctWeightsValueStringWeightsIndicesString(self):
        heights, widths, depths = backend_utils.get_output_dimensions(self.mnist_pool_input)
